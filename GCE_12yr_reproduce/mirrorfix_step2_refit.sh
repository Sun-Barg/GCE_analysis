#!/bin/bash
# mirrorfix_step2_refit.sh — 2단계: 38개 모델 × 3 config 재fit (114 fit)
#
...
# production env 그대로 (production = 토글 미설정)
...
echo "다음 단계: GCE_12yr_visualization.ipynb 04d 5-pipe 셀 재실행"
