...
arXiv:2602.22148, a 5FGL precursor). The analysis extends Sang Hwan Kim's
2025 master's thesis (16-year analysis) to 17 years and from 4FGL-DR4 to
FL16Y. His 16-year code served as an **implementation reference only**;
the methodological reference is Cholis 2022 alone.
...
├── GCE_17yr_visualization.ipynb            <- result visualization (added at publication)
...
# (7) Visualization
# GCE_17yr_visualization.ipynb is added at publication time
