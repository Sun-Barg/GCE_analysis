...
#   · 네임스페이스 격리(위생 규약): 출력 dir = Spectra_Data_sfdm_{ch}_offint_r{r:.2f}
...
#
#   사용 예 (conda env fermi — numpy/pandas만 사용):
#     cd ~/MG5_aMC_v3_5_12
...
MG5_BASE = os.environ.get('MG5_BASE', os.path.expanduser('~/MG5_aMC_v3_5_12'))
