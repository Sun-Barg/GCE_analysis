...
class Interpolator:
    def __init__(self, mass):
        # Load DM masses
        dm_mass = np.loadtxt('/home/sanghwan/Madgraph_3.5.7/MG5_aMC_v3_5_7/bin/test_bb/dm_mass.txt')
        self.mass = mass
        
        # Build unified energy grid from all files
        all_energies = []
        for m in dm_mass:
            data = np.loadtxt(f'/home/sanghwan/Madgraph_3.5.7/MG5_aMC_v3_5_7/bin/test_bb/Events/DM{m}GeV/DM{m}GeV_gamma_v1.dat')
